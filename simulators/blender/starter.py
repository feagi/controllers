...
def transform_multiple_bones_in_pose_mode(armature_name="MyRig", bone_transforms=None):
    """
...
def main():
    ...
    # transform_multiple_bones_in_pose_mode("ClassicMan_Rigify", bone_transforms)
